...
class Select2Controls {
  ...
  _initSelect2Multiple() {
    ...
    jQuery('#select2FundingSource').select2({});
    jQuery('#select2FundingModel').select2({});
    jQuery('#select2ProviderName').select2({});
    jQuery('#select2DocumentType').select2({});
    jQuery('#select2DocumentType2').select2({});
    jQuery('#select2DocumentType3').select2({});
    jQuery('#select2DocumentType4').select2({});
    jQuery('#select2DocumentType5').select2({});
    jQuery('#select2DocumentType6').select2({});
    jQuery('#select2DocumentType7').select2({});
    jQuery('#select2GISDocumentType').select2({});
    jQuery('#select2GISDocumentType2').select2({});
    jQuery('#select2ProjectType').select2({});
    jQuery('#select2NetworkType').select2({});
    jQuery('#select2TransmissionType').select2({});
  }
  ...
  _initTopLabel() {
    ...
    jQuery('#selectCostDesignFeetMiles').select2({minimumResultsForSearch: Infinity, placeholder: ''});
    jQuery('#selectAerialFeetMiles').select2({minimumResultsForSearch: Infinity, placeholder: ''});
    jQuery('#selectSubsurfaceConduitFeetMiles').select2({minimumResultsForSearch: Infinity, placeholder: ''});
    jQuery('#selectSubsurfaceBuriedFeetMiles').select2({minimumResultsForSearch: Infinity, placeholder: ''});
  }
