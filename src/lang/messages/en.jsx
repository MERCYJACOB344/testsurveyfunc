const enMessages = {
  ...
  'menu.fcr': 'FCR',
  'menu.createfcr': 'Create New FCR',
  'menu.editfcr': 'Edit Selected FCR',
  'menu.viewfcr': 'View Selected FCR',

  'menu.myalerts': 'My Alerts',
  'menu.manage_alert_settings': 'Manage Alert Settings',

  'menu.dashboard': 'Dashboard',

 

  'menu.documentlibrary': 'Document Library',
  'menu.uploaddocuments': 'Upload Documents',
  'menu.retrievedocuments': 'Retrieve Documents',

  'menu.reporting': 'Reporting',
  'menu.standardreports': 'Standard Reports',
  'menu.customreports': 'Generate Custom Report',

  'menu.admin': 'Admin',
  'menu.announcementmanagement': 'Announcement Management',
  // 'menu.groupmanagement': 'User Management',
  'menu.usermanagement': 'User Management',
  'menu.initiation': 'Work Initiation',
  'menu.gis' : 'GIS',
  'menu.fieldSide': 'FieldSide',
  'menu.createInitiation':'Create Work Request',
  'menu.gridInitiation' : 'Request List'
};
