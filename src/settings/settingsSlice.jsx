...
import { DEFAULT_SETTINGS } from '../config.jsx';
...
export const { settingsChangeRadius, settingsChangeNavColor, settingsChangeLayout, settingsResetLayout, setPlacement } = settingsSlice.actions;
