const bootstrapIcons = [
  ...
  {
    c: 'bi-music-note',
    t: ['music', 'note', 'fieldsurvey', 'audio', 'sound', 'media'],
  },
  {
    c: 'bi-music-note-beamed',
    t: ['music', 'note', 'beamed', 'fieldsurvey', 'audio', 'sound', 'media'],
  },
  {
    c: 'bi-music-note-list',
    t: ['music', 'note', 'list', 'fieldsurvey', 'audio', 'sound', 'playlist', 'library', 'media'],
  },
  {
    c: 'bi-music-player',
